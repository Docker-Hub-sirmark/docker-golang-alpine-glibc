...
No `latest` tag, please use specific version tags.
 ...
 - [`1.26-alpine-glibc`](https://github.com/Docker-Hub-sirmark/docker-golang-alpine-glibc/blob/main/1.26/alpine-glibc/Dockerfile)

## Docker Pull Command

```console
docker pull sirmark/golang:1.26-alpine-glibc
```
